...
ARMS = {"slo": "Llumnix SLO", "fluidserve": "FluidServe (prefix off)",
        ...
        "fsv3cap_r2": "FluidServe v0.3, + cap (repeat 2)",
        "fsv3nofrc": "FluidServe v0.3 (force off)",
        "fsv3nofrc_r2": "FluidServe v0.3, force off (repeat 2)",
        "fsv3capnofrc": "FluidServe v0.3 (cap, force off)",
        "fsv3capnofrc_r2": "FluidServe v0.3, cap + force off (repeat 2)",
        "fsv3capg": "FluidServe v0.3 (+ guardrail cap)",
        "fsv3capg_r2": "FluidServe v0.3, guardrail cap (repeat 2)",
        "fsv3capgnofrc": "FluidServe v0.3 (guardrail cap, force off)",
        "fsv3capgnofrc_r2": "FluidServe v0.3, guardrail cap + force off (repeat 2)",
        "llmdslo_r2": "llm-d (repeat 2)",
